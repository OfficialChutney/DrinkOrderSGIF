...
public interface IDrinkService
{
    ...
    Task<Drink> AddDrinkAsync(string name, int price, int unitsPerPrice, int? klipsPrice, CancellationToken cancellationToken = default);
    Task UpdateDrinkAsync(Guid drinkId, string name, int price, int unitsPerPrice, int? klipsPrice, CancellationToken cancellationToken = default);
